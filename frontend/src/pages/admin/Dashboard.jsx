              ...
              <tbody className="divide-y divide-border">
                {recent.map((a) => (
                  <tr key={a.id} className="hover:bg-surface-overlay/50 transition-colors">
                    <td className="px-4 py-4 text-body font-medium text-text-primary">{a.title}</td>
                    ...
                    <td className="px-4 py-4 text-right">
                      <Link to={`/admin/analytics/${a.id}`} className="inline-flex items-center text-meta text-text-secondary hover:text-accent transition-colors">
